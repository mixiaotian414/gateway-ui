...
export async function query (params) {
  return request({
    url:  '/gateway/linksyntree.json',
    method: 'post',
    data:params,
  })
  /*return request({
    url:  '/api/v1/connectionlist',
    method: 'GET',
    data:params,
  })*/
}

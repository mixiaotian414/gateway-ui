    ...
    return (
      <div className={styles.configMain}>
        <div  className={classnames(styles["ant-transfer"])}>
          <div  style={{width:" 350px", height:" 300px", marginLeft:"20px"}} className={classnames(styles["ant-transfer-list"],styles["ant-transfer-list-with-footer"])}>
            <div  className={classnames(styles["ant-transfer-list-header"])}>
              <span className={classnames(styles["ant-transfer-list-header-selected"])}>{this.props.type=="quota"?"指标树":"机构"}
              </span>
            ...
            {this.props.type=="quota"?<IndexCard {...indexCardProps}/>:<OrganizationCard {...indexCardProps}/>}
        ...
        <div  style={{width:" 350px", height:" 300px"}} className={classnames(styles["ant-transfer-list"],styles["ant-transfer-list-with-footer"])}>
          <div  className={classnames(styles["ant-transfer-list-header"])}>
